...
# -*- coding: utf-8 -*-
#
# pyos documentation build configuration file, created by
...
module = SourceFileLoader(
    "version",
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "pyos", "version.py"),
).load_module()
...
latex_documents = [
    (master_doc, 'pyos.tex', 'pyOS Documentation', 'Martin Uhrin', 'manual'),
]
...
man_pages = [(master_doc, 'pyos', 'pyOS Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'pyos', 'pyOS Documentation', author, 'pyos', 'One line description of project.',
     'Miscellaneous'),
]
